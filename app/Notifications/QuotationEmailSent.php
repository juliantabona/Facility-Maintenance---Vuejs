...
class QuotationEmailSent extends Notification
{
    use Queueable;
    ...
    public function customTemplate()
    {
        return [
            ...
            'grand_total_value' => $this->quotation->grand_total_value,
            'currency_type' => $this->quotation->currency_type,
            'created_date_value' => $this->quotation->created_date_value,
            'expiry_date_value' => $this->quotation->expiry_date_value,
