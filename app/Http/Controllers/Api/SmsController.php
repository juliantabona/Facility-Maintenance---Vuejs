    ...
    public function sendSampleSms()
    {
        ...
        if (!$type) {
            ...
            $invoice = json_decode(json_encode([
                ...
                'created_date_value' => Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())->format('Y-m-d'),
                'expiry_date_title' => $companySettings['invoiceTemplate']['expiry_date_title'],
                'expiry_date_value' => Carbon::createFromFormat('Y-m-d H:i:s', Carbon::now())->addWeek()->format('Y-m-d'),
