...
class TrackingDetails extends ResourceCollection
{
    /**
     ...
     * @var string
     */
    public $collects = 'App\Http\Resources\TrackingDetail';
    ...
    public function toArray($request)
    {
        return [
            ...
            '_links' => [
                ...
                //  Link to search tracking details
                'search' => [
            ...
            '_embedded' => [
                'tracking_details' => $this->collection,
            ],
