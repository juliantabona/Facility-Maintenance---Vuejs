...
class UssdInterfaces extends ResourceCollection
{
    /**
     ...
     * @var string
     */
    public $collects = 'App\Http\Resources\UssdInterface';
    ...
    public function toArray($request)
    {
        return [
            ...
            '_links' => [
                ...
                //  Link to search ussd interfaces
                'search' => [
            ...
            '_embedded' => [
                'ussd_interfaces' => $this->collection,
            ],
