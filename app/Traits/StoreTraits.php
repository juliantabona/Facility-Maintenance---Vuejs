...
trait StoreTraits
{
    ...
    public function initiateCreate($storeInfo = null)
    {
        ...
        try {
            ...
            if ($this->storeInstance) {
                ...
                /* Add the store addresses (if any) */
                $this->storeInstance->addAddresses();

                /* Add the store phones (if any) */
                $this->storeInstance->addPhones();

                /* Add the store emails (if any) */
                $this->storeInstance->addEmails();
     ...
     */
    public function initiateUpdate($storeInfo = null)
    {
        //  Get the authenticated user
        $user = auth('api')->user();
        ...
        /*
         *  The $template variable represents accepted structure of the store
         *  data required to update a new resource.
         */
        $template = [
            'name' => $storeInfo['name'] ?? null
        ];
        ...
        try {
            /*
             *  update the existing store, then retrieve a fresh instance
             */
    ...
    public function addAddresses()
    {
        ...
        if (isset($storeInfo['address'])) {
            ...
            $this->createAddress($storeInfo['address']);
    ...
    public function addPhones()
    {
        ...
        if (isset($storeInfo['phone'])) {
            /*  Create a new phone  */
            $this->createPhone($storeInfo['phone'], $requires_verification = true);
        ...
        /*  If we have many phones  */
            ...
            foreach ($storeInfo['phones'] as $phone) {
                /*  Create a new phone  */
                $this->createPhone($phone, $requires_verification = true);
            }
        }
    }
