<template>
    ...
    <div>
        ...
        <fadeLoader :loading="isSavingRecurringSchedulePlan" msg="Saving schedule plan, please wait..." class="mt-1 mb-3"></fadeLoader>

        <!-- Stage card  -->
        <stagingCard 
            :stageNumber="1" 
            :showStageNumber="showStageNumber" 
            ...
            <template slot="leftContent">
                ...
                <h4 v-if="showSubHeader" :class="'text-secondary' + ( isEditingStage ? ' mt-3 mb-4': '')">Schedule Plan:</h4>

                <div v-if="!isEditingStage" :class="'d-inline-block'+(showSubHeader ? ' mt-2' : ' mt-4')" :style="{ lineHeight: '1.6em' }">
            ...
            <template slot="extraContent">
                ...
                <Row v-if="isEditingStage">
                    ...
                    <Col span="24" :class="(showSubHeader ? '' : 'mt-4')">
                        ...
                        <span v-show="localRecurringSettings.schedulePlan.chosen == 'Weekly'" class="mb-3">
                            ...
                            <Select v-model="localRecurringSettings.schedulePlan.weekly" :style="{ width:'120px', marginTop:'-5px' }" class="float-left d-block" placeholder="Select day of week"
                                    @on-change="updateSchedulePlans()" :multiple="true">
                        ...
                        <span v-show="localRecurringSettings.schedulePlan.chosen == 'Custom'" class="mb-3">
                            ...
                            <span v-show="localRecurringSettings.schedulePlan.custom.chosen == 'Years'">
                                ...
                                <Select v-model="localRecurringSettings.schedulePlan.custom.years.day" :style="{ width:'60px', marginTop:'-5px' }" class="float-left mb-3" placeholder="Select day"
                                    ...
                                    <Option value="1830PM">18:30 PM</Option>
                                    <Option value="1900PM">19:00 PM</Option>
                                    <Option value="1930PM">19:30 PM</Option>
                                    <Option value="2000PM">20:00 PM</Option>
                                    <Option value="2030PM">20:30 PM</Option>
                                    <Option value="2100PM">21:00 PM</Option>

                                    <Option value="2130PM">21:30 PM</Option>
                                    <Option value="2200PM">22:00 PM</Option>
                                    <Option value="2230PM">22:30 PM</Option>
                                    <Option value="2300PM">23:00 PM</Option>
                                    <Option value="2330PM">23:30 PM</Option>
                                    <Option value="0000AM">00:00 AM</Option>

                                    <Option value="0030AM">00:30 AM</Option>
                                    <Option value="0100AM">01:00 AM</Option>
                                    <Option value="0130AM">01:30 AM</Option>
                                    <Option value="0200AM">02:00 AM</Option>
                                    <Option value="0230AM">02:30 AM</Option>
                                    <Option value="0300AM">03:00 AM</Option>

                                    <Option value="0330AM">03:30 AM</Option>
                                    <Option value="0400AM">04:00 AM</Option>
                                    <Option value="0430AM">04:30 AM</Option>
                                    <Option value="0500AM">05:00 AM</Option>
                                    <Option value="0530AM">05:30 AM</Option>
                                </Select>
                            </span>
                        </span>
                    </Col>
                    ...
                    <Col span="24 mb-3">
                        ...
                        <!-- Set the time -->
                        <span class="mb-3">
                            <span class="float-left d-block ml-1 mr-1">Always start at</span>
                            ...
                            <span class="float-left d-block ml-3 mr-1">and end at</span>
                            <Select v-model="scheduleEndTime" :style="{ width:'90px', marginTop:'-5px' }" class="float-left d-block" placeholder="Select day"
                                    @on-change="updateSchedulePlans()">
                            ...
                            <Col span="24">
                                ...
                                <focusRipple color="blue" :ripple="rippleEffect" class="float-right">
                                    ...
                                    <Button v-if="isEditingStage" class="float-right" type="primary" size="large" @click="saveSchedulePlan()">
                                        <span>{{ showNextStepBtn ? 'Next Step' : 'Save Changes' }}</span>
                                    </Button>
        ...
        methods: {
            ...
            saveSchedulePlan(){
                ...
                if( this.url ){
                    ...
                    self.$emit('saved', self.localRecurringSettings);
                }
