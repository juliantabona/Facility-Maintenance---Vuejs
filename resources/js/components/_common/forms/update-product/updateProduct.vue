...
<template>
    ...
    <div>
        ...
        <!-- Form -->
        <el-form class="product-form" :model="formData" :rules="formDataRules" ref="formData">
            ...
            handleAllowVariantsBeforeChange () {
                return new Promise((resolve) => {
                    ...
                    if(this.formData.allow_variants){
                        ...
                        console.log('Replace with original');
                        console.log(this.variantAttributesBeforeChange);
