...
<template>
    ...
    <div>
        ...
        <el-form :model="formData" :rules="formDataRules" ref="formData">
            ...
            <!-- Name -->
            <el-form-item label="Store Name" prop="name" class="mb-2" :error="customErrors.name">
                <el-input type="text" v-model="formData.name" size="small" style="width:100%" placeholder="Enter store name"></el-input>
            </el-form-item>

            <!-- Phone number -->
            <el-form-item label="Mobile Number" prop="mobile_number" class="phone-number mb-3" :error="customErrors.mobile_number">

            <Poptip trigger="hover" content="This mobile number will receive SMS notifications of orders placed by your customers" 
                    word-wrap width="300">
    ...
    export default {
        ...
        methods: {
            ...
            handleCreate(){
                 ...
                 *  create store information after a successful post request. We can use the then() hook 
                 *  to determine what to do next. In this case we update the parent vue component and 
                 *  pass the created store information.
                */
                var self = this;
            ...
            updateFormFieldValues(currentFormData = this.store)
            {
                //  Get the form fields
