    ...
    export default {
        ...
        methods: {
            handleSave(){
                 ...
                 *  updated creator information after a successful put request. We can use the then() hook 
                 *  to determine what to do next. In this case we update the parent vue component and 
                 *  pass the updated creator information.
                */
                var self = this;
            ...
            {
                var currentFormData = this.creatorData;
