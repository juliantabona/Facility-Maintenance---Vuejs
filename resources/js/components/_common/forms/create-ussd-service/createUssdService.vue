    ...
    export default {
        ...
        methods: {
            ...
            handleCreate(){
                 ...
                 *  create service information after a successful post request. We can use the then() hook 
                 *  to determine what to do next. In this case we update the parent vue component and 
                 *  pass the created service information.
                */
                var self = this;
            ...
            updateFormFieldValues(currentFormData = this.service)
            {
                //  Get the form fields
