<template>
    <div>
        <Modal
            ...
            <Select v-if="!isLoading && fetchedCategories" v-model="localCategories" :style="{ width:'100%' }" placeholder="Select cost centers" multiple not-found-text="No cost centers found">
    ...
    export default {
        ...
        methods: {
            fetch() {
                ...
                console.log('Start getting jobcard cost centers...');

                //  Use the api call() function located in resources/js/api.js
                api.call('get', '/api/costcenters?costcenter_type=jobcard')
                    .then(({data}) => {
                    ...
                    .catch(response => { 
                        console.log('updateCostCentersModal.vue - Error getting jobcard cost centers...');
