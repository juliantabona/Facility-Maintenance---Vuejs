            ...
            <div v-if="showSettings" class="field-editor mt-3">
                ...
                <el-row :gutter="20" class="settings-box">
                    ...
                    <el-col :span="12" class="mb-2 mt-2">
                        ...
                        <el-switch @change="isMultiple(selectedOption)" v-model="fieldInstance.multiple" active-text="Yes" inactive-text="No"></el-switch>
                    </el-col>
                    <el-col :span="12" class="mb-2 mt-2">
        ...
        methods: {
            ...
            isMultiple(field){
                if(field.multiple && !Array.isArray(field.value)){
                    field.value = [];
                }else if(!field.multiple && Array.isArray(field.value)){
                    field.value = '';
                }
            },
