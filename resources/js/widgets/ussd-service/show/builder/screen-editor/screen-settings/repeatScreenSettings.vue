<template>
    ...
    <div>
        ...
        <repeatOnItemsSettings v-if="localScreen.type.repeat.selected_type == 'repeat_on_items'" :screen="localScreen" :builder="builder"></repeatOnItemsSettings>
        
        <!-- Repeat On Number Settings -->
        <repeatOnNumberSettings v-if="localScreen.type.repeat.selected_type == 'repeat_on_number'" :screen="localScreen" :builder="builder"></repeatOnNumberSettings>
