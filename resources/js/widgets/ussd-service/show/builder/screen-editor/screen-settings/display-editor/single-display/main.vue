        ...
        <Row v-if="showContent" class="display-details">
            ...
            <Col :span="24">
                ...
                <div class="clearfix mb-3">
                    ...
                    <!-- Display Action -->
                    <displayAction v-show="activeNavTab == 'Action'" :display="localDisplay" :screen="screen" :builder="builder"></displayAction>

                    <!-- Display Events -->
                    <displayEvents v-show="activeNavTab == 'Events'" :display="localDisplay" :screen="screen" :builder="builder"></displayEvents>
