<template>
    ...
    <!-- Currency Selector -->
    <Select v-if="localfetchedCompanies.length" v-model="localSelectedCompany" :style="{ width:'100%' }" :placeholder="placeholder" not-found-text="No companies found" filterable>
        <Option 
