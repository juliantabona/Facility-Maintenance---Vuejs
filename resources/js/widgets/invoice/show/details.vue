<template>
    ...
    <Row :gutter="20">
        ...
        <Col span="8">
            ...
            <p v-if="!localEditMode" class="text-dark">{{ localInvoice.grand_total_value | currency(currencySymbol) || '___' }}</p>
            <el-input v-if="localEditMode" :placeholder="'e.g) '+currencySymbol+'5,000.00'" :value="localInvoice.grand_total_value | currency(currencySymbol)" size="mini" class="mb-2" :style="{ maxWidth:'155px', float:'right' }" disabled></el-input>
        </Col>
    </Row>
