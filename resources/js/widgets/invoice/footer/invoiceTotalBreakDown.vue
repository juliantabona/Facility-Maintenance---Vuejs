    ...
    <div>
        ...
        <Row :gutter="20" class="doubleUnderline mt-3">
            ...
            <Col :span="localEditMode ? '8':'4'">
                ...
                <p v-if="!localEditMode" class="text-dark text-right float-right w-100"><strong>{{ localInvoice.grand_total_value | currency(currencySymbol) }}</strong></p>
                <el-input v-if="localEditMode" :placeholder="'e.g) '+currencySymbol+'5,000.00'" :value="localInvoice.grand_total_value | currency(currencySymbol)" size="mini" class="mb-2" :style="{ maxWidth:'250px', float:'right' }" disabled></el-input>
