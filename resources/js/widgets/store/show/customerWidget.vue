                        ...
                        return h(orderRowDropDown, {
                            ...
                            on: {
                                updated: (customer) => {
                                    ...
                                    for(var x=0; x < this.localCustomers.length; x++){
                                        ...
                                        if( x == params.index){
                                            ...
                                            this.$set(this.localCustomers[x], '_expanded', false);
                ...
                if( this.localCustomersUrl ){
                    ...
                    api.call('get', this.localCustomersUrl)
                        ...
                        .catch(response => { 
                            ...
                            console.log('resources/js/widgets/store/show/customerWidget.vue - Error getting customers...');
