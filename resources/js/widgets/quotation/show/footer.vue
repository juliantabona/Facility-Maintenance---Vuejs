...
<template>
    ...
    <footer :style="'background-color:'+primaryColor+';border-radius: 0 0 4px 4px;'">
        <div class="mt-1">
            <span v-if="!editMode">{{ localQuotation.footer }}</span>
            <el-input v-if="editMode" :placeholder="'e.g) Terms And Conditions Apply'" v-model="localQuotation.footer" size="mini" :style="{ width:'50%', margin:'0 auto' }"></el-input>
        </div>     
    </footer>
