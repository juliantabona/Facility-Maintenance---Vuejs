    ...
    <Card class="quotation-summary-widget" :style="{ width: '100%' }">
        ...
        <div slot="extra" v-if="showMenuBtn">
            ...
            <Dropdown trigger="click" class="mr-4">
                ...
                <DropdownMenu slot="list">
                    ...
                    <DropdownItem v-if="showMenuAddAssetBtn">Print Quotation</DropdownItem>
                </DropdownMenu>
            </Dropdown>
        ...
        <Row>
            ...
            <Col span="12" class="pr-4">
                <h1 class="text-dark text-right" style="font-size: 35px;">QUOTATION</h1>
        ...
        <Row>
            ...
            <Col span="12">
                <Row :gutter="20">
                    <Col span="16">
                        <p class="text-dark text-right"><strong>Estimate Number:</strong></p>
                        <p class="text-dark text-right"><strong>Estimate Date:</strong></p>
                        <p class="text-dark text-right"><strong>Expires On:</strong></p>
