    ...
    <Row>   
        ...
        <Col :span="24">
            ...
            <recurringSchedulePlanStage 
                ...
                :recurringSettings="localAppointment.recurring_settings" 
                :showHeader="!localAppointment.has_approved_recurring_schedule"
                :showCheckMark="localAppointment.has_set_recurring_schedule_plan && !(((localAppointment.recurring_settings || {}).editing || {}).schedulePlan)"
                :showNextStepBtn="localAppointment.has_set_recurring_schedule_plan"
                :isEditing="(((localAppointment.recurring_settings || {}).editing || {}).schedulePlan)"
            ...
            <recurringDeliveryPlanStage 
                resourceName="appointment"
                resourceNamePlural="appointments"
                :client="localAppointment.client"
                ...
                :recurringSettings="localAppointment.recurring_settings" 
                :disabled="!localAppointment.has_set_recurring_schedule_plan"
                :showCheckMark="localAppointment.has_set_recurring_delivery_plan && !(((localAppointment.recurring_settings || {}).editing || {}).deliveryPlan)"
                :showToggleSwitch="localAppointment.has_set_recurring_schedule_plan && (((localAppointment.recurring_settings || {}).editing || {}).deliveryPlan)"
                :showSummary="localAppointment.has_set_recurring_schedule_plan && !(((localAppointment.recurring_settings || {}).editing || {}).deliveryPlan)"
                :showSettings="localAppointment.has_set_recurring_schedule_plan && (((localAppointment.recurring_settings || {}).editing || {}).deliveryPlan)"
                :showInformationalMessage="!localAppointment.has_set_recurring_schedule_plan && !(((localAppointment.recurring_settings || {}).editing || {}).deliveryPlan)"
                :showActionBtns="localAppointment.has_set_recurring_schedule_plan"
                :showSaveChangesText="localAppointment.has_set_recurring_delivery_plan"
                :isEditing="(((localAppointment.recurring_settings || {}).editing || {}).schedulePlan)"
                :url="'/api/appointments/'+localAppointment.id+'/recurring/update-delivery-plan'"
                :style="{ position:'relative', zIndex: 4 }" 
                @saved="$emit('saved', $event)">
            </recurringDeliveryPlanStage>
            ...
            <recurringApprovalStage 
                ...
                resourceNamePlural="appointments"
                :recurringSettings="localAppointment.recurring_settings" 
                :disabled="!localAppointment.has_set_recurring_delivery_plan"
                :showCheckMark="localAppointment.has_approved_recurring_settings"
                :showActionBtns="localAppointment.has_set_recurring_delivery_plan"
                :hasApproved="localAppointment.has_approved_recurring_settings"
                :rippleEffect="localAppointment.has_approved_recurring_settings"
                :url="'/api/appointments/'+localAppointment.id+'/recurring/approve'"
...
<script type="text/javascript">
    ...
    export default {
        ...
        watch: {
            ...
            appointment: {
                handler: function (val, oldVal) {
                    ...
                    if(!this.localAppointment.recurring_settings){
                        this.localAppointment.recurring_settings = this.getRecurringSettingsTemplate();
                    }
                },
                deep: true
            }
        ...
        created(){
            ...
            if(!this.appointment.recurring_settings){
                this.localAppointment.recurring_settings = this.getRecurringSettingsTemplate();
            }
        }
    }
