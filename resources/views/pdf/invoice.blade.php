...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="tr0 td2 mrt3">
                                ...
                                <table cellpadding="0" cellspacing="0" class="mrt2">
                                    ...
                                    <tr>
                                        <td class="tr0 td2">
                                            <p class="p6 ft1 pdl6">{{ $invoice['reference_no_title'] }}:</p>
                                        </td>
            
                                        <td class="tr0 td2">
                                            <p class="p5 ft2 pdr4">{{ $invoice['reference_no_value'] }}</p>
                                        </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tr0 td2">
                                                <p class="p6 ft1">{{ $invoice['created_date_title'] }}:</p>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="tr0">
                                                <p class="p6 ft1">{{ $invoice['expiry_date_title'] }}</p>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="td10 tr0">
                                                <p class="ft1 p6 pd2">{{ $invoice['grand_total_title'] }}:</p>
                                            </td>
                        ...
                        @if( isset($invoice['items']) && !empty($invoice['items']) )
                            @foreach($invoice['items'] as $key => $item)
                                <tr style="background-color:{{ ( ($key + 1) % 2 ) ? $secondaryColor . ' !important': '' }} ;">
                                    ...
                                    <td rowspan="2" colspan="1" class="pdt1">
                                        <p class="ft2 mrt1" style="line-height:16px;margin-top: 0px;margin-bottom: 0px;">{{ number_format($item['unit_regular_price']*$item['quantity'],2,",",".") }}</p>
                                    </td>
                                </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="tr12 td31">
                                <p class="ft1 p11 pdr3" style="text-align:right;">{{ $invoice['sub_total_title'] }}:</p>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="brt brb2">
                                <p class="ft1 p11 pdr3">{{ $invoice['grand_total_title'] }}:</p>
                            </td>
        ...
        <footer style="background-color:{{ $primaryColor }} !important;">
            <p style="margin-top:2px;">{{ $invoice['footer'] }}</p>
        </footer>
